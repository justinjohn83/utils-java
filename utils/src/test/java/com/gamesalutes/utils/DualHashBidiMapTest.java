 ...
 * @version $Id: DualHashBidiMapTest.java 1271 2009-01-16 20:45:44Z jmontgomery $
 */
public class DualHashBidiMapTest extends AbstractBidiMapTest {
	...
	{
		return new DualHashBidiMap<Integer,Integer>();
	}
	...
	{
		return new DualHashBidiMap<Integer,Integer>(m);
	}
