 ...
 * @version $Id: SynchronizedGraphTest.java 995 2008-06-26 17:35:28Z jmontgomery $
 */
public class SynchronizedGraphTest extends GraphTest 
{
	...
	{
		return new SynchronizedGraph<Integer,Integer>(new 
				AdjacencyList<Integer,Integer>(true));
	}
	...
	{
		return new SynchronizedGraph<Integer,Integer>(new 
				AdjacencyList<Integer,Integer>(false));
	}
