...
/**
 * Empty stub implementation of <code>Communicator</code>.
 * 
 * @author Justin Montgomery
 * @version $Id: NullCommunicator.java 1486 2009-05-12 22:26:41Z jmontgomery $
 */
public class NullCommunicator<S,T> implements Communicator<S,T>
{
	...
	public void setConnectionCallback(ConnectionCallback connListener) {}
