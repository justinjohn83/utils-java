...
/**
 * Default implementation of a tree listener that simply accepts every node and returns <code>true</code>.
 * 
 * @author Justin Montgomery
 * @version $Id:$
 */
public class DefaultTreeListener<T> implements Listener<T>
{
